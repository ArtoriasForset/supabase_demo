...
export default function RootLayout({
  ...
  return (
    <html lang="cn">
      <body
        className="min-h-screen flex flex-col bg-gradient-to-r from-gray-50 via-blue-200 to-gray-50"
      >
        <header>
          <nav className="flex text-sl items-end h-full z-10 bg-white">
            ...
            <div className="relative group p-4 transform hover:bg-gray-200 transition z-10">
              <Link href="/" className="p-4 font-semibold hover:underline underline-offset-8">首页</Link>
              <div className="absolute absolute left-0 top-full bg-gray-200 invisible group-hover:visible opacity-0 group-hover:opacity-100">
                <Link href="/" className="block p-4 text-gray-700 hover:bg-gray-100 hover:text-red-500">
                  宣传页面
                </Link>
                <Link href="/" className="block p-4 text-gray-700 hover:bg-gray-100 hover:text-red-500">
                  业务介绍
            ...
            <div className="relative group p-4 transform hover:bg-gray-200 transition w-32 z-10">
              <Link href="/" className="p-4 font-semibold hover:underline underline-offset-8">公司简介</Link>
            ...
            <div className="relative group p-4 transform hover:bg-gray-200 transition w-36 z-10">
              <Link href='/' className="p-4 font-semibold hover:underline underline-offset-8">产品与服务</Link>
            ...
            <div className="relative group p-4 transform hover:bg-gray-200 transition w-36 z-10">
              <Link href="/" className="p-4 font-semibold hover:underline underline-offset-8">客户端下载</Link>
              <div className="absolute text-center w-36 absolute left-0 top-full bg-gray-200 invisible group-hover:visible opacity-0 group-hover:opacity-100">
                <Link href="/" className="block p-4 text-gray-700 hover:bg-gray-100 hover:text-red-500">
                  安卓下载
                </Link>
            ...
            <div className="ml-auto flex items-center space-x-4 m-4 overflow-visible">
              <p>联系电话 </p>
